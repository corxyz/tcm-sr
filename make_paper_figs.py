import sys
import numpy as np
import util, plotting, pachinko_sim, bias_var, pstop_sim
...
# NOTE: Panels of figure 5 are generated by learn_sr.py and limited_samp.py
...
panel_to_make = '3a3b3c3d3e'   # specify panel letter
...
if 3 in fig_to_make:
  ...
  for i, pstop in enumerate(pstops):
    ...
    samped, vsamp, vtrue, ve = pstop_sim.run_sim(n_exp, n_trial, n_row, n_col, n_rew, s0, M_ext, M_effect, pstop,
...
if 6 in fig_to_make:
  ...
  for i, pstop in enumerate(pstops):
    ...
    samped, vsamp, vtrue, ve = pstop_sim.run_sim(n_exp, n_trial, n_row, n_col, n_rew, s0, M_ext, M_rev, pstop, reachable=s0,
